...
class LicenceFeeWaterCharge extends Model
{
    ...
    {
        $FeesData = LicenceFeeWaterCharge::Leftjoin('erp_house_master','erp_license_water_tariff.house_type_id','=','erp_house_master.house_type_id')
                                          ->Leftjoin('erp_house_type','erp_house_master.house_type_id','=','erp_house_type.house_type_id')->get();
        return $FeesData;        
    }
