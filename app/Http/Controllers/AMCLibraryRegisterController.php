...
class AMCLibraryRegisterController  extends Controller
{
    ...
    public function AMCLibraryRegister(Request $request)
    {
        $AmcLibraryData = Null;
        $AmcLibraryData = $this->AMCPurchaseOrder->showLibraryAMCPoDetails(NULL);
        
        return view('register.amc-library-register')->with('data', compact('AmcLibraryData'));
    }
