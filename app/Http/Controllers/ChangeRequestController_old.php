...
{   
    ...
    {   
       /*  if(((session('WcmsRoleGroupCode') == "ADMUSER")||(session('WcmsRoleGroupCode') == "SUPUSER"))){
        ...
        if(isset($request->SaveDraft)){  
         ...
         $Empdata = $this->Employee->ShowEmployeeBySessionEmpNo(); 
        return view('change-request.empaddr-change-request')->with('data',compact('Empdata'));  
    ...
    { 
        ...
        /* if(((session('WcmsRoleGroupCode') == "ADMUSER")||(session('WcmsRoleGroupCode') == "SUPUSER"))){
            ...
            $Empdata = $this->Employee->ShowEmployeeBySessionEmpNo();     
        return view('change-request.empcontact-change-request')->with('data',compact('Empdata'));  
    }
    ...
    {   
        ...
        if(isset($request->btn_save)){  
            ...
            //$Bankdata = $this->bank->ShowBankList(NULL);
           ...
           //dd($Branchdata);
            return view('change-request.empbankdetails-change-request')->with('data',compact('Empdata','Branchdata')); 
    } 
    ...
    {   
           /*  if(((session('WcmsRoleGroupCode') == "ADMUSER")||(session('WcmsRoleGroupCode') == "SUPUSER"))){
            ...
            $Empdata = $this->Employee->ShowEmployeeBySessionEmpNo(); 
            return view('change-request.empfamilydetails-change-request')->with('data',compact('Empdata','DependentData')); 
    }  
    ...
    {   
       ...
       if(isset($request->btn_save)){  
            ...
            try { 
                ...
                $SaveArr2['phy_challange_type'] = $request->txt_perc_old;
                $SaveDataold = json_encode($SaveArr2);
         ...
         $Empdata = $this->Employee->ShowEmployeeBySessionEmpNo(); 
         return view('change-request.physicaldisability-change-request')->with('data',compact('Empdata')); 
    }
    ...
    {   
       ...
       /*  if(((session('WcmsRoleGroupCode') == "ADMUSER")||(session('WcmsRoleGroupCode') == "SUPUSER"))){
        ...
        return view('change-request.maritalstatus-change-request')->with('data',compact('Empdata','MaritalData')); //ID Card Application
    }
    ...
    {   
             $Empdata = $this->Employee->ShowEmployeeBySessionEmpNo();
            return view('change-request.tada-exp-claim-request')->with('data',compact('Empdata')); //TA/DA Expenses Claim Application
    } 
    ...
    {   
             $Empdata = $this->Employee->ShowEmployeeBySessionEmpNo();
            return view('change-request.cpf-gpf-advan-request')->with('data',compact('Empdata')); //CPF/GPF Advance Application 
    } 
    public function WitDrawFrCPFGPFRequest(Request $request)
    {   
             $Empdata = $this->Employee->ShowEmployeeBySessionEmpNo();
            return view('change-request.witdraw-fr-cpf-gpf-request')->with('data',compact('Empdata')); //WIthdraw from CPF/GPF Application
    }
