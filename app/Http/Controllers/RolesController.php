...
class RolesController extends Controller
{
    ...
    public function RoleMaster(Request $request){
        ...
        return view('roles.master.RoleMaster')->with('data',compact('RoleDataView','OfficeList','RoleGroup','RoleData')) ->with('ALertMesage',$message);
    }

    public function ViewRoleMaster(Request $request)
    {
        $LogData = [];
        $LogData['MODULE_CODE'] = 'ROLE';
        $LogData['ACTION']      = 'VIEW';
        ...
        return view('roles.master.ViewRoleMaster')->with('data',compact('data'));
    }
}