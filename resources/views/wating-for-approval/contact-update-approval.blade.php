								...
								<div class="row innerdiv">
									<div class="row">  -->
										...
										<div class="form-step active">
											<div class="div12">
												<div class="table-box">
													<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Employee Contact  Update -  Waiting for Approval List</div></div></div>
															...
															<table class="table-bordered table1" width="99%" align="center" id="dataTable">
																<thead>
																	<tr class="note heading">
																		...
																		<th  style="text-align:center">Existing Contact No.</th>
																		<th  style="text-align:center">New Contact No.</th>
																...
																@if(isset($data['ContactData']))
																	@foreach($data['ContactData'] as $ContactData)  
																		@php
																			...
																			if(isset($EmpGroupedData[$ContactData->emp_no])){
																				$EmpData 	= $EmpGroupedData[$ContactData->emp_no];
																		...
																		<tr>
																			...
																			<td align="left">{{ $ContactData->emp_no }}</td>
																			<td align="left">{{ $ContactData->emp_name_payslip }}</td>
																			<td align="left">{{ $OfficeName }}</td>
																			<td align="left">{{ $ExistingContact }}</td>
																			<td align="left">{{ $NewContact }}</td>
																			<td align="left"></td>
																		</tr>
																	@endforeach
																@endif
