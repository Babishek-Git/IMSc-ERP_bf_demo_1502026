								...
								<div class="row innerdiv">
									<div class="row">  -->
										...
										<div class="form-step active">
											<div class="div12">
												<div class="table-box">
													<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Employee Bank Update -  Waiting for Approval List</div></div></div>
															...
															<table class="table-bordered table1" width="99%" align="center" id="dataTable">
																<thead>
																	<tr>
																		...
																		<th colspan="3" style="text-align:center">Existing Bank Detail</th>
																		<th colspan="3" style="text-align:center">New Bank Details</th>
																		<th rowspan="2" style="text-align:center">Supporting Document</th>
																	</tr>
																	<tr>
																		<th style="text-align:center" nowrap="">Account No.</th>
																		<th style="text-align:center">Bank Name</th>
																		<th style="text-align:center" nowrap="">IFSC</th>
																		<th style="text-align:center" nowrap="">Account No.</th>
																		<th style="text-align:center">Bank Name</th>
																		<th style="text-align:center" nowrap="">IFSC</th>
																	</tr>
																...
																@if(isset($data['BankData']))
																	@foreach($data['BankData'] as $BankData)  
																		@php
																			...
																			if(isset($EmpGroupedData[$BankData->emp_no])){
																				$EmpData 	= $EmpGroupedData[$BankData->emp_no];
																		...
																		<tr>
																			...
																			<td align="left">{{ $BankData->emp_no }}</td>
																			<td align="left">{{ $BankData->emp_name_payslip }}</td>
																			<td align="left">{{ $OfficeName }}</td>

																			<td align="left">{{ $ExistingAccountNo }}</td>
																			<td align="left">{{ $ExistingBankName }}</td>
																			<td align="left">{{ $ExistingIfscCode }}</td>

																			<td align="left">{{ $NewAccountNo }}</td>
																			<td align="left">{{ $NewBankName }}</td>
																			<td align="left">{{ $NewIfscCode }}</td>
