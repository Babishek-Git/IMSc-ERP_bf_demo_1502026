								...
								<div class="row innerdiv">
									<div class="row">  -->
										...
										<div class="form-step active">
											<div class="div12">
												<div class="table-box">
													<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Employee Address Update -  Waiting for Approval List</div></div></div>
															...
															<table class="table-bordered table1" width="99%" align="center" id="dataTable">
																<thead>
																	<tr class="note heading">
																		...
																		<th  style="text-align:center">Existing Address</th>
																		<th  style="text-align:center">New Address</th>
																...
																@if(isset($data['AddressData']))
																	@foreach($data['AddressData'] as $AddressData)  
																		@php
																			...
																			if(isset($EmpGroupedData[$AddressData->emp_no])){
																				$EmpData 	= $EmpGroupedData[$AddressData->emp_no];
																			...
																			$ExistingAddres = optional(json_decode($AddressData->old_value))->emp_address ?? '';
																			$NewAddres = optional(json_decode($AddressData->new_value))->emp_address ?? '';
																		@endphp
																		<tr>
																			<td align="center">{{ $loop->iteration }} </td>
																			<td align="left">{{ $AddressData->emp_no }}</td>
																			<td align="left">{{ $AddressData->emp_name_payslip }}</td>
																			<td align="left">{{ $OfficeName }}</td>
																			<td align="left">{{ $ExistingAddres }}</td>
																			<td align="left">{{ $NewAddres }}</td>
																			<td align="left"></td>
																		</tr>
																	@endforeach
																@endif
