								...
								<div class="row innerdiv">
									<div class="row">  -->
										...
										<div class="form-step active">
											<div class="div12">
												<div class="table-box">
													<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Stock Register</div></div></div>
															...
															<table class="table-bordered table1" width="99%" align="center" id="dataTable">
																<thead>
																	<tr>
																		...
																		<th rowspan="2" style="text-align:center; width:40%">Particulars</th>
																		<th rowspan="2" style="text-align:center width:8%;">V.No. /Bill No.</th>
																		<th colspan="2" style="text-align:center">Receipt</th>
																		<th colspan="2" style="text-align:center">Issued</th>
																		<th colspan="2" style="text-align:center">Balance</th>
																	</tr>
																	<tr>
																		<th style="text-align:center" nowrap="">Qty</th>
																		<th style="text-align:center">Unit</th>
																		<th style="text-align:center" nowrap="">Qty</th>
																		<th style="text-align:center" nowrap="">Unit</th>
