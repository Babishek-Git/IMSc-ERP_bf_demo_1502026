								...
								<div class="row innerdiv">
									<div class="row">  -->
										...
										<div class="form-step active">
											<div class="div12">
												<div class="table-box">
													<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Inventory Register</div></div></div>
															...
															<table class="table-bordered table1" width="99%" align="center" id="dataTable">
																<thead>
																	<tr>
																		...
																		<th style="text-align:center;width:10%;">Date Of Receipt</th>
																		<th style="text-align:center;width:60%;">Descrption Of Article</th>
																		<th style="text-align:center;width:40%;">Supplier's Name</th>
																		<th style="text-align:center;width:10%;">Bill No.& Date</th>
																		<th style="text-align:center;width:8%;">Qty Received</th>
																		<th style="text-align:center;width:6%;">Rate  (Rs.)</th>
																		<th style="text-align:center;width:8%;">Total Cost(Rs.)</th>
																		<th style="text-align:center;width:10%;">Payment Voucher No.& Date</th>
																		<th style="text-align:center;width:50%;">Location of the article</th>
