								...
								<div class="row innerdiv">
									<div class="row">  -->
										...
										<div class="form-step active">
											<div class="div12">
												<div class="table-box">
													<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">List Of Annual Maintanence contract Library</div></div></div>
															...
															<table class="table-bordered table1" width="99%" align="center" id="dataTable">
																<thead>
																	<tr>
																		...
																		<th rowspan="2" style="text-align:center; width:30%">Description Of Equipments</th>
																		<th rowspan="2" style="text-align:center; width:30%">Name Of The Company/Manufacturer/Authorized Dealer</th>
																		<th colspan="2" style="text-align:center;width:20%">Period</th>
																		<th rowspan="2" style="text-align:center">AMC Charges Including GST In Rs.</th>
																	
																	</tr>
																	<tr>
																		<th style="text-align:center" nowrap="">From</th>
																...
																<tbody>
																	<tbody>
																		@if(isset($data['AmcLibraryData']))
																			@foreach($data['AmcLibraryData'] as $AmcLibraryData)
																				<tr>
																					<td>{{ $loop->iteration }}</td>
																					<td>{{ $AmcLibraryData->equip_desc }}</td>
																					<td>{{$AmcLibraryData->name_contractor}}</td>
																					<td></td>
																					<td></td>
																					<td>{{ $AmcLibraryData->amc_cost }}</td>
																				</tr>
																			@endforeach
																		@endif
																	</tbody>
