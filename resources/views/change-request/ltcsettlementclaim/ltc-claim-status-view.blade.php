...
@php
	...
	if(isset($data['FromPage'])){
		...
		$BackUrl ='ltc-claim.ltc-claim-status-list';
	}	
@endphp
<style>
	.nborder td{
						...
						<div class="div12" style="margin-top:0px;">
							<div class="div12" style="padding:2px; margin-top:8px;">
								<div class="mbtable">
									...
									<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="left">&emsp;LTC Settlement Claim  Status</div></div></div>
							...
							<div class="div12" style="padding:2px; margin-top:8px;">
								<div class="mbtable">
									<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="left">&emsp; LTC Settlement Claim  Request File Transaction</div></div></div>
													...
													<div class="row namebox">
														...
														<table class="formtable" width="100%">
															<tr>
																...
																<th class="lboxlabel" nowrap="">LTC Settlement Claim file From </th>
																<th class="lboxlabel" nowrap="">LTC Settlement Claim file  To </th>
