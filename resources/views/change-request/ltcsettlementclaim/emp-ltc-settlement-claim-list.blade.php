					...
					<div class="container" align="center">
					 	...
					 	<div class="div12 no-margin">
							<div class="rm-toolbar">
								<span class="rm-with-selected-btn" id="rm-withSelectedBtn">LTC Claim Request List</span>
								...
								<div class="rm-toolbar-right">
									...
									@php $AddUrl  = 'change-request.ltc-settlement-change-request'; @endphp 
									@php $BackUrl = 'change-request.ltc-settlement-change-request-list'; @endphp 
									@if($Page == 'REQ_APPLY')
									@if($LTCDataCount>0)
