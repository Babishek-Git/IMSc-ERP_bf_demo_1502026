...
if(isset($data['EditClaimData']))
{
	...
	$ChangeRequestId 	= $EditClaimData->ltc_advance_id;
				...
				<blockquote class="bq1" style="overflow:auto">
											...
											<div class="row" align="right">
												...
												@if($ActionStatus == 'REQ_PROCESS')
													...
													@if(($WorkFlowActionData['WorkFlowAction'] ?? null) === 'SU')
														@if(in_array($ICNo, $selectedFamilyIds))
															@if($Leaveexits && $Leaveexits->isNotEmpty())
															...
															@else
																<button type="button" class="step-btn readonly" id="Ltcleave-req">Submit</button>
															@endif
														@else
															<button type="submit" id="SubmitApplication" name="SubmitApplication" data-flag="SU" class="step-btn WorkFlowAction" value="SUBMIT">Submit</button>
														@endif
													...
													<div class="div2 label">
														<div class="div6 no-margin">
															<div class="inputGroup paddlr2">
																<input {{!empty($EditClaimData) ? $EditClaimData->spouse_employed == "Y" ? "checked" : "" : ""}} id="rad_spouse_employed_yes" name="rad_spouse_employed" 
																	type="radio" value="Y"/>
					...
					<div class="row">
						<div class="div12" align="center">
							...
							<input type="hidden" name="wf_module_code" id="wf_module_code" value="{{ encrypt('LTCCLAIM') }}" />
