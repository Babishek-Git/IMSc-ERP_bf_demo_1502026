					...
					<div class="container" align="center">
					 	...
					 	<div class="div12 no-margin">
							<div class="rm-toolbar">
								<span class="rm-with-selected-btn" id="rm-withSelectedBtn">LTC Advance Request List</span>
								...
								<div class="rm-toolbar-right">
									...
									@php $AddUrl = 'change-request.ltc-adv-change-request'; @endphp 
									@php $BackUrl = 'change-request.ltc-adv-change-request-list'; @endphp 
									@if($Page == 'REQ_APPLY')
									@if($LTCDataCount>0)
							...
							<div class="rm-table-wrap">
								<table id="rm-empTable">
									<thead>
										...
										<th class="rm-sortable" data-col="name"><div class="rm-th-inner">Print<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="width:12px;height:12px"><path d="M7 8l5-5 5 5M7 16l5 5 5-5"/></svg></div></th>
										...
										@if(isset($data['LTCData']))
											@foreach($data['LTCData'] as $LTCData)
												<tr data-name="{{ $LTCData->emp_no }}" data-status="{{ $LTCData->active == 1 ? 'active' : 'inactive' }}">
													...
													<td>{{ $LTCData->emp_name_payslip }}</td>
													<td>{{ $LTCData->designation_name }}</td>
...
>>>>>>> Stashed changes
													...
													<td align="center"><label class="rm-toggle"><input type="checkbox" {{ $LTCData->active == 1 ? 'checked' : '' }}><span class="rm-slider"></span></label></td>
												</tr>
											@endforeach
										@endif
