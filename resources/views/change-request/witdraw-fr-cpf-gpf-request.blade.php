					...
					<div class="container">
						<div class="row plr">
							...
							<div class="div12 mbtable">
								<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Withdraw from CPF/GPF Application Form</div></div></div>
								<div class="row innerdiv">
									<div class="row"> 
										...
										<div class="form-step active"> 
											...
											<fieldset class="fieldbox">
												<legend class="fieldbox-legend">Withdraw from CPF/GPF Information</legend>
												<div class="fieldbox-div">
