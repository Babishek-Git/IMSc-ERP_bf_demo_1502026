...
@php
 ...
 if(isset($data['Empdata'])){
	...
	$OldHome = collect($Empdata)->pluck('emp_hometown')->first();
										...
										<div class="form-step active"> 
											...
											<fieldset class="fieldbox">
												...
												<div class="fieldbox-div">
													...
													<div class="div3">
														<textarea name="txt_old_hometown" id="txt_old_hometown" rows="4" class="tboxsmclass" readonly>@if(isset($OldHome)){{$OldHome}}@endif</textarea>
													</div>
											...
											<fieldset class="fieldbox">
												...
												<div class="fieldbox-div">
													...
													<div class="div3">
														<textarea name="txt_new_hometown" id="txt_new_hometown" rows="4" class="tboxsmclass alphanumeric">@if(isset($NewAddress)){{$NewAddress}}@endif</textarea>
													</div>
