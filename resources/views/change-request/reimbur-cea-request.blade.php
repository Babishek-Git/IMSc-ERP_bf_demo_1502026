															...
															@if(isset($data['ChildrenData']))
																...
																@foreach($TwoChildrenData as $ChildrenData)
																	...
																	<tr>
																		...
																		<td align="left" style="width:90px" ><input type="text" name="txt_academic_year_{{ $ChildrenData->family_det_id }}" id="txt_academic_year_{{ $ChildrenData->family_det_id }}" class="tboxsmclass" value=""></td>
																		...
																		<td align="left" style="width:50px"><input type="text" name="txt_distance_{{ $ChildrenData->family_det_id }}" id="txt_distance_{{ $ChildrenData->family_det_id }}" class="tboxsmclass" value="" ></td>
																		<td align="left" style="width:50px"><input type="checkbox" name="ch_is_disable_{{ $ChildrenData->family_det_id }}" id="ch_is_disable_{{ $ChildrenData->family_det_id }}" class="tboxsmclass" value="" ></td>
																		<td align="left" style="width:50px"><input type="text" name="txt_disable_nature_{{ $ChildrenData->family_det_id }}" id="ch_disable_nature_{{ $ChildrenData->family_det_id }}" class="tboxsmclass" value="" >
																		<td align="left" style="width:50px"><input type="text" name="txt_certi_date_{{ $ChildrenData->family_det_id }}" id="txt_certi_date_{{ $ChildrenData->family_det_id }}" class="tboxsmclass datepicker" value="" ></td>
																		<td align="left" style="width:50px"><input type="text" name="txt_perc_{{ $ChildrenData->family_det_id }}" id="txt_perc_{{ $ChildrenData->family_det_id }}" class="tboxsmclass" value="" ></td>
																		<td align="left" style="width:50px"><input type="checkbox" name="ch_bonofide_{{ $ChildrenData->family_det_id }}" id="ch_bonofide_{{ $ChildrenData->family_det_id }}" class="tboxsmclass" value="" >
																		<td align="left" style="width:50px"><input type="checkbox" name="ch_bonofide_hostel_{{ $ChildrenData->family_det_id }}" id="ch_bonofide_hostel_{{ $ChildrenData->family_det_id }}" class="tboxsmclass" value="" ></td>
																		<td align="left" style="width:50px"><input type="text" name="txt_bonofide_hostel_amt_{{ $ChildrenData->family_det_id }}" id="txt_bonofide_hostel_amt_{{ $ChildrenData->family_det_id }}" class="tboxsmclass" value="" ></td>
																	</tr>
																@endforeach
															@endif
														</tbody>
