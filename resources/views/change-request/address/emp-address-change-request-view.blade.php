...
if(isset($data['EditClaimData']))
{
	...
	$ExistingAddress = optional(json_decode($EditClaimData->old_value))->emp_address ?? '';
	$NewAddress      = optional(json_decode($EditClaimData->new_value))->emp_address ?? '';
				...
				<blockquote class="bq1" style="overflow:auto">
					<div class="container">
						<div class="row plr">
							...
							<div class="div12 mbtable">
								<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Address Update -  Request Form</div></div></div>
									...
									<div class="row"> 
										...
										<div class="form-step active"> 
											<div class="row" align="right">
												@php 
												if($Page == 'REQ_APPLY'){
													$BackUrl = 'change-request.address-change-request-list'; 
												}else if($Page == 'REQ_PROCESS'){
													$BackUrl = 'change-request.address-change-request-pending-list'; 
												}else{
													$BackUrl = 'change-request.address-change-request-list'; 
												}
												@endphp
											...
											<fieldset class="fieldbox">
												<legend class="fieldbox-legend"> Existing Address  </legend>
												<div class="fieldbox-div">
													<div class="div2 label">
														Existing Address <span class="reqindi">*</span>
													</div>
													<div class="div3">
														<textarea name="txt_cont_oldaddress" id="txt_cont_oldaddress" rows="4" class="tboxsmclass" readonly>@if(isset($OldAddress)){{$OldAddress}}@endif</textarea>
													</div>
											...
											<fieldset class="fieldbox">
												<legend class="fieldbox-legend"> New Address </legend>
												<div class="fieldbox-div">
													<div class="div2 label">
														New Address <span class="reqindi">*</span>
													</div>
													<div class="div3">
														<textarea name="txt_cont_address" id="txt_cont_address" rows="4" class="tboxsmclass alphanumeric">@if(isset($NewAddress)){{$NewAddress}}@endif</textarea>
													</div>
					...
					<div class="row">
						<div class="div12" align="center">
							...
							<input type="hidden" name="wf_module_code" id="wf_module_code" value="{{ encrypt('ADDRESS') }}" />
