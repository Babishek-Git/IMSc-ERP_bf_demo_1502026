					...
					<div class="container">
						<div class="row plr">
							...
							<div class="div12 mbtable">
								<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">CPF/GPF Advance Application Form</div></div></div>
								<div class="row innerdiv">
									<div class="row"> 
										...
										<div class="form-step active"> 
											...
											<fieldset class="fieldbox">
												...
												<div class="fieldbox-div">
													...
													<div class="div2"><input type="text" name="txt_emp_icno" id="txt_emp_icno" class="tboxsmclass" value="@if(isset($ICNo)){{$ICNo}}@endif"></div>
													...
													<div class="div2"><input type="text" name="txt_dob" id="txt_dob" class="tboxsmclass" value="@if(isset($EmpDOB)){{Helper::DisplayDateFormat($EmpDOB)}}@endif"></div>
													<div class="div2 label pd-l-20">Date of Joining</div>
													<div class="div2"><input type="text" name="txt_doj" id="txt_doj" class="tboxsmclass" value="@if(isset($EmpDOJ)){{Helper::DisplayDateFormat($EmpDOJ)}}@endif"></div>
													<div class="div2 label pd-l-20">Date of Retirement</div>
													<div class="div2"><input type="text" name="txt_date_retire" id="txt_date_retire" class="tboxsmclass" value="@if(isset($EmpDOJ)){{Helper::DisplayDateFormat($EmpDOJ)}}@endif"></div>
											...
											<div class="row smclearrow"></div>
											<fieldset class="fieldbox">
												<legend class="fieldbox-legend">CPF/GPF Advance Information</legend>
												<div class="fieldbox-div">
													<div class="div3 label">
															Purpose for which applied <span class="reqindi">*</span>
													</div>
													<div class="div9">
														<select name="cmb_indent_no_date" id="cmb_indent_no_date" class="tboxsmclass ChosenInput">
															<option value="">---------- Select ----------</option>
															@if(isset($data['Cpfdata']))
																@foreach($data['Cpfdata'] as $Cpfdata)
																	<option value="{{$Cpfdata->cpfa_id}}">{{$Cpfdata->cpfa_desc}} </option>
																@endforeach
															@endif
														</select>
													</div>
													<div class="div2 label">
														Any additional information on the purpose in Support of application <span class="reqindi">*</span>
													</div>
													<div class="div10">
														<textarea name="txt_purpose_applied" id="txt_purpose_applied" rows="4" class="tboxsmclass alphanumeric"></textarea>
													</div>
													<div class="row smclearrow"></div>
													<div class="row smclearrow"></div>
												</div>
										...
										@php $BackUrl = 'request-updates.cpf-gpf-advan-request'; @endphp
