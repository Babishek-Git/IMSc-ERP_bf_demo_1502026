...
if(isset($data['EditClaimData']))
{
	...
	$NewPercentage      = optional(json_decode($EditClaimData->new_value))->phy_challange_perc ?? '';
	$NewPhysicalType    = optional(json_decode($EditClaimData->new_value))->phy_challange_type ?? '';
					...
					<div class="container">
									...
									<div class="row"> 
										...
										<div class="form-step active"> 
											<div class="row" align="right">
												@php 
												if($Page == 'REQ_APPLY'){
													$BackUrl = 'change-request.physical-disability-change-request-list'; 
												}else if($Page == 'REQ_PROCESS'){
													$BackUrl = 'change-request.physical-disability-change-request-pending-list'; 
												}else{
													$BackUrl = 'change-request.physical-disability-change-request-list'; 
												}
												@endphp
               		...
               		<div class="row">
						<div class="div12" align="center">
							...
							<input type="hidden" name="wf_module_code" id="wf_module_code" value="{{ encrypt('DISABILITY') }}" />
