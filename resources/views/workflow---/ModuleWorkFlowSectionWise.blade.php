								...
								<div class="div12 mbtable">
									...
									<div class="card-body padding-1 ChartCard" id="CourseChart">
										<div class="divrowbox innerdiv pt-2">
											...
											<div class="row smclearrow"></div>                                                                              											
											<div class="row">
												<div class="div2 label">Section <span class="reqindi">*</span></div>
												<div class="div4">
											...
											<div class="row smclearrow"></div>                                                                              											
											<div class="row">
												<div class="div2 label">Sub-Section <span class="reqindi">*</span></div>
												<div class="div4">
...
$("body").on("change",".module", function(event){
	...
	$.ajax({ 
		type: 'POST', 
		url: "{{ route('ajax.GetSectionModuleWorkFlow') }}",
