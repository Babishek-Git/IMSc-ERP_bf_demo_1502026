					...
					<blockquote class="bq1" style="overflow:auto">
						<div class="container">
							<div class="row plr">
									<div class="div5">
										<div class="form-box">
											<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">House Vacation</div></div></div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													<div class="divrowbox innerdiv pt-2">
														...
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>                                                                                											
														<div class="div4 label">House Address<span class="reqindi">*</span></div>
										...
										<div class="div7">
									<div class="table-box">
										<div class="row"><div class="div12" style="margin-top:0px;"><div class="row table-divhead" align="center">House Vacation List</div></div></div>
										<div class="card-body padding-1 ChartCard" id="CourseChart">
											<div class="divrowbox innerdiv pt-2">
...
<script type="text/javascript" language="javascript">
    ...
    if ((EmpNo!='') && (EmpNo!=null)) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('HouseMaster.GetHouseData') }}",
            data: { "_token": "{{ csrf_token() }}", 'EmpNo': EmpNo },
                success: function (data) {
                if (data != '') {
                    let HouseData = data['HouseData']; 
                    if ((HouseData != '') && (HouseData != null)) {
                        $.each(HouseData, function (index, element) {
						   $("#txt_house_addr").val(element.house_address);
