					...
					<blockquote class="bq1" style="overflow:auto">
						<div class="container">
							<div class="row plr">
									<div class="div5">
										<div class="form-box">
											<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">House Master</div></div></div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													<div class="divrowbox innerdiv pt-2">
																				
														<div class="row smclearrow"></div>                                                                                											
														<div class="div3 label">House Code <span class="reqindi">*</span></div>
														<div class="div9"><input type="text" name="txt_house_code" id="txt_house_code" class="tboxclass" value=""></div>
														<div class="row smclearrow"></div>

														<div class="row smclearrow"></div>                                                                                											
														<div class="div3 label">House Address <span class="reqindi">*</span></div>
														<div class="div9"><input type="text" name="txt_house_addr" id="txt_house_addr" class="tboxclass" value=""></div>
														<div class="row smclearrow"></div>

														<div class="div3 label">
															House Category<span class="reqindi">*</span>
														</div>
														<div class="div9">
															<select name="cmb_house_type" id="cmb_house_type" class="tboxclass">
																<option value="">-------------- Select -------------</option>
																@if(isset($data['HouseType']))
																@foreach($data['HouseType'] as $HouseType)
																	<option value="{{$HouseType->house_type_id}}">{{$HouseType->house_type_name}}</option>
																@endforeach
																@endif
															</select>
														</div>
										...
										<div class="div7">
									<div class="table-box">
										<div class="row"><div class="div12" style="margin-top:0px;"><div class="row table-divhead" align="center">House Master List</div></div></div>
										<div class="card-body padding-1 ChartCard" id="CourseChart">
											<div class="divrowbox innerdiv pt-2">
												...
												<table class="table-bordered table1" width="99%" align="center" id="dataTable">
													<thead>
														<tr class="note heading">
															...
															<th  style="text-align:center">House Category</th>
													...
													@if(isset($data['HouseData']))
														@foreach($data['HouseData'] as $HouseData)
															<tr>
																...
																<td><button type="button" name="btn_edit" class="btn btn-default tuploadbtn" id="btn_edit" value=" Edit" onclick="window.location='{{ route('HostelMaster.HostelMaster',['id'=>encrypt($HouseData->house_id)]) }}'"> <i class='fa fa-edit'></i> Edit </button></td>
