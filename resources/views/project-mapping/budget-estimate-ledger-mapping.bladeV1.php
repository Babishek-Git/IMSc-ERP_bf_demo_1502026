					...
					<blockquote class="bq1" style="overflow:auto">
						<div class="container">
							<div class="row">
								<div class="div12">
									<div class="form-box">
										<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Object Heads - Ledger Mapping & BE - RE Entry Form </div></div></div>
                                                    ...
                                                    <table class="attTable">
                                                        ...
                                                        <tbody> 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $ObjectHeadGroup->full_heads }}</td>
                                                                <td width="250px">
																	<select name="cmb_ledger[]" id="cmb_ledger" class="tboxsmclass ChosenInput" multiple>
																		...
																		<option value="{{ $LedgerGroup->ledger_group_id }}">{{ $LedgerGroup->ledger_group_name }}</option>
																		@endforeach
																		@endif
																	</select>
																</td>
