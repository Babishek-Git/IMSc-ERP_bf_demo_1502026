										...
										<table class="attTable">
											...
											@if(isset($data['EmployeeList']))
												...
												<tr>
													...
													<td><input type="number" class="tboxsmclass InpPresentDays CalcAttendance" name="txt_present[]" id="txt_present_{{$AttIndex}}" min="0" max="31" value="@if(isset($TotalPresent)){{$TotalPresent}}@endif" data-index="{{$AttIndex}}"></td>
