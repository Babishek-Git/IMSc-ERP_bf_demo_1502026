...
if(isset($data['EditEmpBasicData'])){
	...
	$EmpICNo       = collect($EditEmpBasicData)->pluck('emp_no')->first();
	$EmpFirstName  = collect($EditEmpBasicData)->pluck('emp_first_name')->first();
	$EmpFatherName = collect($EditEmpBasicData)->pluck('emp_father_name')->first();
	$EmpMotherName = collect($EditEmpBasicData)->pluck('emp_mother_name')->first();
	...
	$MaterialSatus = collect($EditEmpBasicData)->pluck('emp_marital_status')->first();
	...
	$GroupId       = collect($EditEmpBasicData)->pluck('group')->first();
	$DivId         = collect($EditEmpBasicData)->pluck('division_short_name')->first();
	$SecId         = collect($EditEmpBasicData)->pluck('section')->first();
	$Maritalstaus  = collect($EditEmpBasicData)->pluck('emp_marital_status')->first();
	$MoblieNo      = collect($EditEmpBasicData)->pluck('emp_mobile')->first();
										...
										<div class="form-step"> 
											...
											<fieldset class="fieldbox">
												...
												<div class="fieldbox-div">
													...
													<input type="hidden" name="txt_emp_icno" id="txt_emp_icno" class="tboxsmclass pd-l-20" value="@if(isset($EmpFirstName)){{$EmpFirstName}}@endif">
													@endif
														...
														<select name="cmb_visitor_catagory" id="cmb_visitor_catagory" class="tboxsmclass ChosenInput">
															...
															@if(isset($data['VisitorCatagory']))
																@foreach($data['VisitorCatagory'] as $VisitorCatagory)
																	<option value="{{$VisitorCatagory->visitor_cata_id}}">{{$VisitorCatagory->visit_cata_name}}</option>
																@endforeach
															@endif
														</select>
													</div>
													...
													<div class="div2"><input type="text" name="txt_emp_icno" id="txt_emp_icno" class="tboxsmclass"value="@if(isset($EmpICNo)){{$EmpICNo}}@endif" ></div>
													<div class="div2 label label pd-l-20">Salutation <span class="reqindi">*</span></div>
													<div class="div2">
													...
													<div class="row smclearrow"></div>	
													<div class="div2 label">Employee Name <span class="reqindi">*</span></div>
													<div class="div2"><input type="text" name="txt_emp_first_name" id="txt_emp_first_name" class="tboxsmclass" value="@if(isset($EmpFirstName)){{$EmpFirstName}}@endif"></div>
													<div class="div2 label pd-l-20">Father Name</div>
													<div class="div2"><input type="text" name="txt_emp_father_name" id="txt_emp_father_name" class="tboxsmclass" value="@if(isset($EmpFatherName)){{$EmpFatherName}}@endif"></div>
													<div class="div2 label label pd-l-20">Mother Name</div>
													<div class="div2"><input type="text" name="txt_emp_mother_name" id="txt_emp_mother_name" class="tboxsmclass" value="@if(isset($EmpMotherName)){{$EmpMotherName}}@endif"></div>
													<div class="row smclearrow"></div>
													<div class="row smclearrow"></div>	
													<div class="div2 label">Name in Payslip <span class="reqindi">*</span></div>
													<div class="div6"><input type="text" name="txt_payslip_name" id="txt_payslip_name" class="tboxsmclass" value="@if(isset($PayslipName)){{$PayslipName}}@endif"></div>
													...
													<div class="div2 label">
														<div class="div6 no-margin">
															<div class="inputGroup paddlr2">
																<input id="rad_gender_male" name="rad_gender" type="radio" value="M" @checked($EmpGender == 'M') />
																<label for="rad_gender_male" style="padding:3px 0px; width:100%"> &nbsp;Male</label>
															</div>
														</div>
														<div class="div6 no-margin">
															<div class="inputGroup paddlr2">
																<input id="rad_gender_female" name="rad_gender" type="radio" value="F" @checked($EmpGender == 'F')/>
													...
													@if(!in_array('VISSTAFF', $data['menuCodes']))
														...
														<div class="div2"><input type="text" name="txt_doj" id="txt_doj" class="tboxsmclass datepicker" value="@if(isset($EmpDOJ)){{Helper::DisplayDateFormat($EmpDOJ)}}@endif"></div>
														<div class="div2 label pd-l-20">Date of Retirement <span class="reqindi">*</span></div>
											...
											<!-- <fieldset class="fieldbox">
												...
												<div class="fieldbox-div">
													...
													<div class="div2"><input type="text" name="txt_mobile" id="txt_mobile" class="tboxsmclass" value="@if(isset($MoblieNo)){{$MoblieNo}}@endif"></div>
											...
											<fieldset class="fieldbox">
													...
													<div class="fieldbox-div">
														...
														<div class="div2"><textarea name="txt_perm_address" id="txt_perm_address" rows="2" class="tboxsmclass alphanumeric">@if(isset($Address)){{$Address}}@endif</textarea></div>
														<div class="div2 label pd-l-20">Email Address</br><i>(Personal)</i></div>
														<div class="div2"><input type="text" name="txt_perm_mailid" id="txt_perm_mailid" class="tboxsmclass" value="@if(isset($EmpHometown)){{$EmpHometown}}@endif"></div>
														<div class="div2 label pd-l-20">Mobile No.</div>
														<div class="div2"><input type="text" name="txt_perm_mobno" id="txt_perm_mobno" class="tboxsmclass" value="@if(isset($EmpHometown)){{$EmpHometown}}@endif"></div>
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>
													</div>
												...
												<fieldset class="fieldbox">
													<legend class="fieldbox-legend">Present Communication Detail</legend>
														...
														<div class="div2 label pd-l-20">Email Address</br><i>(Personal)</i></div>
														<div class="div2"><input type="text" name="txt_office_mailid" id="txt_office_mailid" class="tboxsmclass" value="@if(isset($EmpHometown)){{$EmpHometown}}@endif"></div>
														<div class="div2 label pd-l-20">Office Intercom No.</div>
														<div class="div2"><input type="text" name="txt_office_mobno" id="txt_office_mobno" class="tboxsmclass" value="@if(isset($EmpHometown)){{$EmpHometown}}@endif"></div>
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>
													</div>
										...
										<div class="form-step"> 
											...
											<fieldset class="fieldbox">
												...
												<div class="fieldbox-div">
													...
													<div class="div1 label pd-l-20">IFSC Code <span class="reqindi">*</span></div>
													<div class="div2">
													...
													<div class="div6">
														<input type="hidden" name="txt_branch_id" id="txt_branch_id" class="tboxsmclass" value="@if(isset($BranchName)){{$BranchName}}@endif">
											...
											<fieldset class="fieldbox">
												...
												<div class="fieldbox-div">
													<div class="div2 label pd-l-20">Main Projects</div>
													<div class="div10"> 
											...
											<div class="form-step"> 
												...
												<fieldset class="fieldbox">
													<legend class="fieldbox-legend">HomeTown Detail</legend>
														...
														<div class="div2"><input type="text" name="txt_home_town" id="txt_home_town" class="tboxsmclass alphanumeric"></div>
														<div class="div2 label pd-l-20">State in which Situated</div>
														<div class="div2"><input type="text" name="txt_home_town_state" id="txt_home_town_state" class="tboxsmclass" value="@if(isset($EmpHometown)){{$EmpHometown}}@endif"></div>
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>
														<div class="div2 label pd-l-20">Nearest Railway Station</div>
														<div class="div2"><textarea name="txt_near_railway" id="txt_near_railway" class="tboxsmclass" value="@if(isset($EmpHometown)){{$EmpHometown}}@endif"></textarea></div>
														<div class="div2 label pd-l-20">Address at hometown</div>
														<div class="div2"><textarea name="txt_addr_hometown" id="txt_addr_hometown" class="tboxsmclass" value="@if(isset($EmpHometown)){{$EmpHometown}}@endif"></textarea></div>
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>
													</div>
										...
										<div class="form-step"> 
											@if(!in_array('VISITOR', $data['menuCodes']))
												...
												<legend class="fieldbox-legend">Personal Information</legend>
													<div class="fieldbox-div">
														@if(!in_array('VISITOR', $data['menuCodes']))
														<div class="div3 label pd-l-20">Exact height measurement(in Meters) <span class="reqindi">*</span></div>
														<div class="div2"><input type="text" name="txt_height_measurement" id="txt_height_measurement" class="tboxsmclass" value="@if(isset($ExtenNo)){{$ExtenNo}}@endif"></div>
														@endif
														<div class="div2 label pd-l-20">Blood Group <span class="reqindi">*</span></div>
														<div class="div2"><input type="text" name="txt_blood_group" id="txt_blood_group" class="tboxsmclass" value="@if(isset($MoblieNo)){{$MoblieNo}}@endif"></div>
														<div class="row smclearrow"></div>
														<div class="div3 lboxlabel pd-l-20">Personal marks of Identification <span class="reqindi">*</span></div>											
														<div class="div6"><textarea name="txt_identification_marks" id="txt_identification_marks" rows="4" class="tboxsmclass alphanumeric">@if(isset($Address)){{$Address}}@endif</textarea></div>
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>
													</div>
