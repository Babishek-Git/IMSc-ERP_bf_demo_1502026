...
if(isset($data['EditEmpBasicData'])){
	...
	$PersonalMoblieNo = collect($EditEmpBasicData)->pluck('emp_personal_mobile_no')->first();
										...
										<div class="form-step"> 
														...
														<select name="cmb_emp_salute" id="cmb_emp_salute" class="tboxsmclass ChosenInput">
															...
															@if(isset($data['employeeSalute']))
																@foreach($data['employeeSalute'] as $EmployeeSaluteList)
																	<option value="{{$EmployeeSaluteList->salute_id}}">
																		{{$EmployeeSaluteList->salute_name}}</option>
																@endforeach
															@endif
														</select>
													</div>
														...
														@if(in_array('PDFrIPDF', $data['menuCodes']))
															...
															<div class="div2">
																<select name="cmb_pdforipdf" id="cmb_pdforipdf" class="tboxsmclass ChosenInput">
																	<option value="">------ Select -----</option>
																	<option value="pdf">Ph.D</option>
																	<option value="ipdf">Integrated Ph.D</option>
																</select>
															</div>
															<!-- <div class="div2 label pd-l-20">
											...
											<fieldset class="fieldbox">
													...
													<div class="fieldbox-div">
														...
														<div class="div2"><input type="text" name="txt_perm_mobno" id="txt_perm_mobno" class="tboxsmclass" value="@if(isset($MoblieNo)){{$MoblieNo}}@endif"></div>
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>
														<div class="row smclearrow"></div>
													</div>
										...
										<div class="form-step"> 
											...
											<fieldset class="fieldbox">
												...
												<div class="fieldbox-div">
													...
													<div class="row smclearrow"></div>
													<div class="div2 label pd-l-20">
														Name Of The Faculty Guide<span class="reqindi">*</span>
													</div>
													<div class="div4">
