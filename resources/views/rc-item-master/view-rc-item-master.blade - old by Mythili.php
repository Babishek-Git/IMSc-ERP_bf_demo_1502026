                                                        ...
                                                        <tbody> 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $ItemGroupData->full_heads }}
																	<input type="hidden" id ='hidden_oh_id' name ='hidden_oh_id[]' value = '{{ $ItemGroupData->rc_item_id }}'>
																	<td align="center"><button type="button" name="btn_edit" class="btn btn-default tuploadbtn" id="btn_edit" value=" Edit" onclick="window.location='{{ route('rc-item-master.rc-item-master',['id'=>encrypt($ItemGroupData->rc_item_id)]) }}'"> <i class='fa fa-edit'></i> Edit</button></td>
																</td>
                                                            </tr>
                                                            @endforeach
                                                            @endif
