					...
					<div class="container" align="center">
					 	...
					 	<div class="div12 no-margin">
							<div class="rm-toolbar">
								<span class="rm-with-selected-btn" id="rm-withSelectedBtn">Purchase Order Register</span>
							...
							<div class="rm-table-wrap">
								<table id="rm-empTable">
									...
									<tbody id="rm-tableBody">
										@if(isset($data['ShowPurchaseIssueData']))
											@foreach($data['ShowPurchaseIssueData'] as $Purchasedata)
												<tr data-name="{{ $Purchasedata->created_by }}" data-status="{{ $Purchasedata->active == 1 ? 'active' : 'inactive' }}">
													...
													<td align="center">
														<button type="button" name="btn_submit" class="xlbtndownload m-btm1" id="btn_submit" value="Submit" onclick="window.location='{{ route('purchase-order.purchase-order-register', ['ViewId'=>encrypt($Purchasedata->work_order_id),'page'=>encrypt('VIEW')]) }}'"> <i class='fa fa-check'></i> View Details</button>
													</td>
													<!-- <td align="center">
