                            ...
                            <div class="div12 mbtable">
                                ...
                                <div class="row">
                                    <div class="div12" style="margin-top:0px;">
                                        <div class="row divhead" align="center">Manual Bill Payment</div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-step active">
                                            ...
                                            <fieldset class="fieldbox">
                                                ...
                                                <div class="fieldbox-div">
                                                    ...
                                                    <div class="div2 label">Payment</div>
                                                    <div class="div2 label">
                                                        <input type="radio" name="rad_payment_to" id="rad_payment_to_emp" value="EMPLOYEE">&nbsp; Employee &emsp;&emsp;
                                                        <input type="radio" name="rad_payment_to" id="rad_payment_to_vendor" value="VENDOR">&nbsp; Vendor
                                                        <input type="hidden" name="txt_payment_for" id="txt_payment_for" class="tboxsmclass disable" value="{{ $PaymentFor ?? '' }}" readonly>
                                                    ...
                                                    <div class="div2 label pd-l-20">Name of the Payee</div>
                                                    <div class="div6">
                                                        <select name="cmb_payee" id="cmb_payee" class="tboxsmclass ChosenInput">
                                                            <option value=""> ---- Select ---- </option>
                                                        </select>
                                                        <input type="hidden" name="txt_emp_name" id="txt_emp_name" class="tboxsmclass disable" value="{{ $EmpName ?? '' }}" readonly>
                                                        <input type="hidden" name="txt_emp_icno" id="txt_emp_icno" class="tboxsmclass disable" value="{{ $EmpNo ?? '' }}" readonly>
                                                    </div>
                                            ...
                                            <fieldset class="fieldbox">
                                                ...
                                                <div class="fieldbox-div">
                                                    <input type="hidden" name="txt_vendor_name" id="txt_vendor_name" class="tboxsmclass disable" value="{{ $VendorName ?? '' }}" readonly>
                                            ...
                                            <!-- <fieldset class="fieldbox">
                                                <legend class="fieldbox-legend">Payee Bank Information</legend>
                                                <div class="fieldbox-div">
                                                    <div class="div2 label">Bank Name</div>
                                                    <div class="div2">
                                                    ...
                                                    <table class="attTable">
                                                        ...
                                                        <tbody>
                                                            <tr id="inputRow">
                                                                ...
                                                                <td align="right">
                                                                    <input type="text" class="tboxsmclass" id="txt_received_amt" name="txt_received_amt" value="" readonly>
                                                                </td>
                                                                <td align="right">
                                                                    <input type="text" class="tboxsmclass" id="txt_upto_expenditure_amt" name="txt_upto_expenditure_amt" value="" readonly>
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="tboxsmclass" id="txt_expenditure_amt" name="txt_expenditure_amt" value="{{ $BillAmount ?? '' }}" readonly>
                                                                </td>
                                                                <td>
                                                                    <input type="text" class="tboxsmclass" id="txt_balance_amt" name="txt_balance_amt" value="" readonly>
                                                                </td>
                                                            </tr>
                                                        </tbody>
