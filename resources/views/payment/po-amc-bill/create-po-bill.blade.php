...
if(isset($PoPaymentData)){
    ...
    $PoNo           = collect($PoPaymentData)->pluck('work_order_no')->first();
    $WorkName       = collect($PoPaymentData)->pluck('work_name')->first();
    $WorkOrderDate  = collect($PoPaymentData)->pluck('work_order_date')->first();
    $WorkOrderCost  = collect($PoPaymentData)->pluck('work_order_cost')->first();
                            ...
                            <div class="div12 mbtable">
                                ...
                                <div class="row">
                                    <div class="div12" style="margin-top:0px;">
                                        <div class="row divhead" align="center">PO. Bill Payment</div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="form-step active">
                                            ...
                                            <fieldset class="fieldbox">
                                                <legend class="fieldbox-legend" style="margin-top:0px">PO. Information</legend>
