...
$CurrentMonth 		= $PayGenMonth;
//$CurrentMonthStr 	= strtoupper(date("M-Y"));
$CurrenYear 		= $PayGenYear; 
$AttIndex = 0;
@endphp
											...
											@if(isset($data['EmployeeList']))
												...
												if(isset($CalculatedPayData[$EmployeeList->emp_no])){
													...
													if($EmpCalculatedPayData['calculated_components']){
														...
														$BasicPay = $EmpCalcComponentData['BASIC'] ?? 0;
													}
												}
												$TotalDeduction = 0;
												...
												<tr>
													<td align="center">
														<!-- {{ $loop->iteration }} -->
														<input type="checkbox" name="ch_process[]" id="ch_process_{{$AttIndex}}" data-index="{{$AttIndex}}" value="{{ $EmployeeList->emp_no }}" checked>
													</td>
													<td>
													...
													@endphp
														<td>
															<input type="text" class="tboxsmclass" name="txt_pay_component_{{ $EmployeeList->emp_no }}[]" id="txt_pay_component_{{$AttIndex}}" min="0" max="31" value="{{$ComponentCalcAmount}}" data-index="{{$AttIndex}}">
													...
													@endif
													<td>
														<input type="text" class="tboxsmclass" name="txt_gross_salary[]" id="txt_gross_salary_{{$AttIndex}}" min="0" max="31" value="{{$EmpGrossSalary}}" data-index="{{$AttIndex}}">
													</td>
													...
													<td>
														...
														<input type="text" class="tboxsmclass" name="txt_net_salary[]" id="txt_net_salary_{{$AttIndex}}" min="0" max="31" value="{{$EmpNetSalary}}" data-index="{{$AttIndex}}">
													</td>
													<td>
...
<script>
	...
	$("body").on("click", "#SaveDraft", function(event){
		...
		var form = document.createElement("form");
			form.method = "POST"; 
			form.action = "{{ route('payroll.pay-save') }}";
		...
		var FloatingSubmitBtn 		= document.createElement("input");
			...
			FloatingSubmitBtn.name 	= "btn_save_payroll";
			FloatingSubmitBtn.id 	= "btn_save_payroll";
			form.appendChild(FloatingSubmitBtn);

			$("#btn_save_payroll").trigger("click");
	});
