						...
						<div class="container">
							<div class="row plr">
								...
								<div class="div8 mbtable">
									<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Payroll Generate Initiation</div></div></div>
									<div class="card-body padding-1 ChartCard" id="CourseChart">
										<div class="divrowbox innerdiv pt-2">
											<!-- <div class="instructions">
												<i class="fa fa-info-circle" style="font-size:20px; color: #0D7A73;"></i> Select employee types for payroll generation. Green checkmark indicates successfully / already generated.
											</div>	 -->
...
<script type="text/javascript" language="javascript">
	...
	$("body").on("click","#btn_initiate", function(event){
		if(KillEvent == 0){
			var EmpGrpLength  = $('input[name="ch_emp_group"]:checked').length;//$('input[name="ch_emp_group[]"]:checked').length;
			if(EmpGrpLength == 0) {
