								...
								<div class="div8 mbtable">
									...
									<div class="card-body padding-1 ChartCard" id="CourseChart">
										<div class="divrowbox innerdiv pt-2">
											...
											<div class="div9"><input type="text" name="txt_role_name" id="txt_role_name" class="tboxclass" value=""></div>
											<div class="row smclearrow"></div>
											
											
											<div class="div3 label">
												User Role Group <span class="reqindi">*</span>
											</div>
											<div class="div9">
												<select name="txt_role_group" id="txt_role_group" class="textboxdisplay" style="height:30px;width:180px">
