								...
								<div class="div8 mbtable">
									...
									<div class="card-body padding-1 ChartCard" id="CourseChart">
										<div class="divrowbox innerdiv pt-2">
											...
											<div class="div9"><input type="text" name="work_flow_code" id="work_flow_code" maxlength="50" class="tboxsmclass textonly" value="@if(isset($data['WorkFlowData'])){{ $data['WorkFlowData']->wf_module_code }}@endif"></div>
											<div class="row smclearrow"></div>                                                                                											
											<div class="div3 label">Work Flow Module Name <span class="reqindi">*</span></div>											
											<div class="div9"><input type="text" name="work_flow_module_name" id="work_flow_module_name" maxlength="50" class="tboxsmclass" value="@if(isset($data['WorkFlowData'])){{ $data['WorkFlowData']->wf_module_name }}@endif"></div>
											...
											<div class="div4">
												<select name="work_flow_group_code" id="work_flow_group_code" class="tboxsmclass">
											...
											<div class="row smclearrow"></div> 
											@php $AddUrl = 'workflow.workflow-module-view'; @endphp
											<div class="row">
