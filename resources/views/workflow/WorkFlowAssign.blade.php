                            ...
                            <div class="divrowbox innerdiv pt-2">
                                ...
                                <div class="row">
                                    <div class="div12" align="center">
                                        ...
                                        <input type="submit" class="step-btn" name="btn_change" id="btn_change" value=" Change " />								
                                        @else
                                        <input type="button" class="step-btn" name="btn_change" id="btn_change" value="Change" disabled />
