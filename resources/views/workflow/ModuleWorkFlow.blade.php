											...
											<div class="row"> 
												...
												<div class="div4">
													<select class="group tboxclass" name="cmb_module" id="cmb_module">
														...
														@foreach($data['ModuleData'] as $ModuleData)
														<option value="{{ $ModuleData->wf_moduleid }}" data-mcode="{{ $ModuleData->wf_module_code }}">{{ $ModuleData->wf_module_name }}</option>
														@endforeach
														@endif
													</select>
												</div>
											...
											<div class="row">
												<table class="formtable" align="center" width="100%" id="RoleTable">
													<tr class="label" style="background-color:#FFF">
														...
														<th align="center" style="width:250px">Maximum Approving Authority</th>
														<th align="center" style="width:250px">Initiate Role</th>
														<th align="center" colspan="2">Target Roles</th>
														<th align="center">&nbsp;</th>
													</tr>
													<tr class="label" style="background-color:#FFF">
														<input type="hidden" name="txt_start_range_0" id="txt_start_range_0" class="tboxsmclass hide" maxlength="19" value="0" >
														<input type="hidden" name="txt_end_range_0" id="txt_end_range_0" class="tboxsmclass hide" maxlength="19" value="0" >
														<td align="center">
															<select class="group tboxsmclass" name="cmb_appr_auth_0" id="cmb_appr_auth_0">
																<option value=""> --- Select ----</option>
														...
														<td align="center">
															<select class="group tboxsmclass" name="cmb_init_role_0" id="cmb_init_role_0">
																<option value=""> --- Select ----</option>
																@if(isset($data['RoleData'])) 
																@foreach($data['RoleData'] as $Roles)
																@if($Roles->active == 1)
														...
														<td align="center" style="width:250px">
															<select class="group tboxsmclass" name="cmb_role_0" id="cmb_role_0">
																<option value=""> --- Select ----</option>
																@if(isset($data['RoleData'])) 
																@foreach($data['RoleData'] as $Roles)
																@if($Roles->active == 1)
														...
														<td align="left"><div class="MappedRole" id="MappedRole"></div></td>
														<td align="center" style="width:30px"><i class="fa fa-plus-square sqadd ptr inp disable" id="AddRole" style="font-size:24px; color:#029339"></i></td>
													</tr>
												</table>
											</div>
											@php $AddUrl = 'workflow.ViewModuleWorkFlow'; @endphp										
											<div class="row">
...
$("body").on("click","#AddRole", function(event){
	...
	if(EndRange == ""){
		...
		let RowStr = '<tr class="label" style="background-color:#FFF">';
			RowStr += '<input type="hidden" name="txt_start_range[]" id="txt_start_range_'+Index+'" class="tboxsmclass" value="'+StartRange+'">';
			RowStr += '<input type="hidden" name="txt_end_range[]" id="txt_end_range_'+Index+'" class="tboxsmclass" value="'+EndRange+'">';
			RowStr += '<td align="center"><select class="group tboxsmclass" name="cmb_appr_auth[]" id="cmb_appr_auth_'+Index+'">';
			...
			RowStr += '<td align="center"><select class="group tboxsmclass" name="cmb_init_role[]" id="cmb_init_role'+Index+'">';
...
function ClearRow(){
	$("#txt_start_range_0").val(0);
	$("#txt_end_range_0").val(0);
	$("#cmb_appr_auth_0").val('');
