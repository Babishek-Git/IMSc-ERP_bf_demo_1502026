					 	...
					 	<div class="div12 no-margin">
							<div class="rm-toolbar">
								...
								<div class="rm-toolbar-right">
									...
									@php $AddUrl = 'change-request.maritalstatus-change-request'; @endphp 
									@php $BackUrl = 'change-request.maritalstatus-change-request'; @endphp
									@if($MaritalData>0)
										...
										@if(isset($data['MaritalData']))
											@foreach($data['MaritalData'] as $MaritalData)
												<tr data-name="{{ $MaritalData->emp_no }}" data-status="{{ $MaritalData->active == 1 ? 'active' : 'inactive' }}">
													...
													<td align="center"><button type="button" name="btn_edit" class="btn btn-default tuploadbtn" id="btn_edit" value=" Edit" onclick="window.location='{{ route('change-request.maritalstatus-change-request',['id'=>encrypt($MaritalData->change_req_id),'Page'=>encrypt('ALLREQ')]) }}'"> <i class='fa fa-edit'></i>View &  Edit </button></td>
													<td align="center">
