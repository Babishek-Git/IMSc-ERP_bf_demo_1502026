					...
					<div class="container" align="center">
					 	...
					 	<div class="div12 no-margin">
							<div class="rm-toolbar">
								<span class="rm-with-selected-btn" id="rm-withSelectedBtn">Role List</span>
										...
										@if(isset($data['OfficeGroupData']))
											@foreach($data['OfficeGroupData'] as $OfficeGroupData)
												<tr>
													...
													<td>{{ $OfficeGroupData->full_heads }}</td>
													<td align="center">
														<button type="button" name="btn_edit" id="btn_edit" class="btn btn-default teditbtn estEdit" onClick="window.location='{{route('organization.OfficeCreation', ['id' => encrypt($OfficeGroupData->office_id)])}}'" title="Click here to Edit" style="cursor: pointer;"><i class="fa fa-edit pt2"></i></button>
													</td>
													<td align="center">
													...
													<td align="center"><label class="rm-toggle"><input type="checkbox"><span class="rm-slider"></span></label></td>
												</tr>
											@endforeach
										@endif
