...
$BackUrl ='indent.sanction-document-upload';
@endphp
<style>
	/* .SearchItemMenu {
                            ...
                            <div class="div12 mbtable">
                                ...
                                <div class="row">
                                    <div class="div12" style="margin-top:0px;">
                                        <div class="row divhead" align="center">Indent Sanction Document Upload Details</div>
                                    </div>
                                </div>
                                <div class="row innerdiv">
									<div class="row row-fluid line-control-menu-bar formtitlebar" style="border:none">
										...
										<div class="btn-group floatr"><button type="submit"id="SaveDraft" name="SubmitApplication" data-flag="SD" class="btn btn-default btninfo" value="DRAFT"> <i class="fa fa-pencil-square-o"></i> Upload</button>
               							</div>
               						</div>
                                    <div class="row">
                                        ...
                                        <div class="form-step active">
											...
											<div class="row smclearrow"></div>
											 {{-- ── INDENT SUPPORTING DOCUMENTS TABLE  ── --}}
											<div class="table-container">
												<div class="table-wrapper">
													<div class="section-header">
														<span>Sanction Documents Details</span>
													...
													<table class="formtable" disabled width="100%">
														...
														<tbody id="supp_doc_tbody">	
															@if(isset($SancationDocArr))
																@foreach($SancationDocArr as $DocValue)
																<tr>
																	<td>
																	...
																	<td class="labelcenter" style="text-align:center;">
																			<!-- <a href="{{ route('indent.sanction-document-upload', ['Exptype' => 'SUPPDF']) }}/ESTVI/{{ $DocValue->sup_doc_id }}/{{ $DocValue->sup_doc_id }}"
																			class="pdfbtn"
															...
															<tr>
																<td>
																	<input type="text"  style="width:100%" name="txt_supp_doc_desc[]" id="txt_sno" class="tboxsmclass  "  value="">
																</td>
																<td>
																	<input type="file" id="file_upload" name="file_upload[]" class="step-btn">
																</td>
