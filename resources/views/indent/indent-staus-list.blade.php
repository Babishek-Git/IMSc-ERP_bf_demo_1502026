											...
											<tbody>
												...
												<tr>
														...
														if(isset($Indentstatus)){
															if($Indentstatus == "approved"){
																...
																if(isset($FromRole)){
																	...
																	echo '<span class="blink" style="font-size:12px; color:red;">Not yet submitted</span>';
																}
													...
													<td class="col" align="center">
														<button type="button" onclick="window.location='{{ route('indent.indent-status-view', ['page'=>encrypt('SUBMITED'),'id'=>encrypt($Indentdata->indent_id),'modulecode'=>encrypt('INDENT')])}}'" class="btn btn-default tuploadbtn" title="Click here to View" style="cursor: pointer;"><i class="fa fa-hand-o-right"></i> View Detailed Status</button>
													</td>
												</tr>
												@php
														$Snumber++;
