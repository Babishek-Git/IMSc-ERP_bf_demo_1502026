						...
						<div class="container">
							<div class="row plr">
								...
								<div class="div5 mbtable">
									<!-- <div class="form-box"> -->
										<input type="hidden" name="txt_section_category" id="txt_section_category"  class="tboxsmclass" value="APEX">
										...
										<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">DAE Apex Sanction</div></div></div>
										<div class="card-body padding-1 ChartCard" id="CourseChart">
											<div class="divrowbox innerdiv pt-2">
												...
												<div class="div4 label">DAE Apex Sanction No. <span class="reqindi">*</span></div>											
												<div class="div8"><input type="text" name="txt_sanction_no" id="txt_sanction_no"  class="tboxsmclass" value=""></div>																																																					
												
												<div class="div4 label">DAE Apex Sanction Amount <span class="reqindi">*</span> </div>											
								...
								<div class="div7">
									<div class="table-box">
										<div class="row"><div class="div12" style="margin-top:0px;"><div class="row table-divhead" align="center">DAE Apex Sanction List</div></div></div>
										<div class="card-body padding-1 ChartCard" id="CourseChart">
											<div class="divrowbox innerdiv pt-2">
												...
												<table class="table-bordered table1" width="99%" align="center" id="dataTable">
													<thead>
														<tr class="note heading">
															...
															<th  style="text-align:center">DAE Apex Sanction No.</th>
															<th  style="text-align:center">DAE Apex Sanction Amount</th>
															<th  style="text-align:center">DAE apex Sanction Date</th>
