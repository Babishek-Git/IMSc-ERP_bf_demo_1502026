			...
			<div class="container_12">
				<div class="grid_12">
                  ...
                  <div class="div12">
                      ...
                      function renderTree($parentId, $GroupedProjects, $level = 0, $GrandParent = 0, $OtherParam)
                      {
                          if(isset($GroupedProjects[$parentId]))
                          {
                              foreach($GroupedProjects[$parentId] as $index => $project)
                              {
                                  ...
                                  {
                                      echo '
                                      <table class="attTable" width="100%" style="margin-bottom:10px;">
                                          <tbody>
                                      ';
                                                ...
                                                if(isset($ObjectHeadSubCataGrpData[$ObjectHeadId])){
                                                  ...
                                                  if(filled($ObjectHeadSubCata)){
                                                    foreach($ObjectHeadSubCata as $ObjectHeadSubCataValue){
                                                      echo '<td class="lom-td-obj oh-title" nowrap="" colspan="3" align="right">';
                                  ...
                                  echo '<tr class="'.$rowClass.'">';
                                      ...
                                      if(isset($OtherParam['PaymentIndexed'])){
                                        $PaymentIndexed = $OtherParam['PaymentIndexed'];
                                      }
                                                  ...
                                                  if(filled($ObjectHeadSubCata)){
                                                    foreach($ObjectHeadSubCata as $ObjectHeadSubCataValue){
                                                      ...
                                                      if($isLeaf){
                                                        ...
                                                        $ObjectHeadExpenditureAmt = 0;
                                                        if(isset($PaymentIndexed)){
                                                          $key  = ($ProjectObjectHeadValue->gia_id ?? 0) . '_' .
                                                                  ($ProjectObjectHeadValue->object_head_id ?? 0) . '_' .
                                                                  ($ObjectHeadSubCataValue->oh_sub_cata_id ?? 0) . '_' .
                                                                  ($project->project_id ?? 0) . '_' .
                                                                  ($GrandParent ?? 0);
                                                          $ObjectHeadExpenditureAmt = $PaymentIndexed[$key] ?? 0;
                                                          
                                                        }

                                                        $ObjectHeadBalanceAmt = $ObjectHeadSanctionAmt - $ObjectHeadExpenditureAmt;
                                                        echo '<td class="lom-td-obj" align="right">';
                                                        echo Helper::IndianMoneyFormat($ObjectHeadSanctionAmt);
                                                        echo '</td>';
                                                        echo '<td class="lom-td-obj" align="right">&nbsp;';
                                                        echo Helper::IndianMoneyFormat($ObjectHeadExpenditureAmt);
                                                        echo '</td>';
                                                        echo '<td class="lom-td-obj" align="right">&nbsp;';
                                                        echo Helper::IndianMoneyFormat($ObjectHeadBalanceAmt);
                                                        echo '</td>';
                                                      }else{
                                                        if($level == 0){
                                                          echo '<td class="lom-td-obj" nowrap="" style="color:#fff;font-weight:600">Upto Date Sanctioned';
                                                          echo '</td>';
                                                          echo '<td class="lom-td-obj" nowrap="" style="color:#fff;font-weight:600">Upto Date Expenditure';
                                                          echo '</td>';
                                                          echo '<td class="lom-td-obj" nowrap="" style="color:#fff;font-weight:600">Upto Date Balance';
                                                          echo '</td>';
                                                        }else{
                      ...
                      $PaymentIndexed = $PaymentIndexed ?? [];
                      $OtherParam = ['ObjectHeadGiaMapgrpData'=>$ObjectHeadGiaMapgrpData,'ObjectHeadSubCataGrpData'=>$ObjectHeadSubCataGrpData,'ObjectHeadGrpData'=>$ObjectHeadGrpData,'ApexObjectHeadSanctionData'=>$ApexObjectHeadSanctionData,'SanctionIndexed'=>$SanctionIndexed,'PaymentIndexed'=>$PaymentIndexed];
