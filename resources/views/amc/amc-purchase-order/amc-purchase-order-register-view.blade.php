...
$AMCTypeDataArray           = $data['AMCTypeData'] ?? [];
...
if(isset($data['AMCPORegisterData'])){
	foreach($data['AMCPORegisterData'] as $AMCPOMastData){
...
$BackUrl    ='amc-purchase-order.amc-purchase-order-register';
$GrandTotal = 0;
@endphp
                            ...
                            <div class="div12 mbtable">
                                ...
                                <div class="row">
                                    <div class="div12" style="margin-top:0px;">
                                        <div class="row divhead" align="center">AMC Purchase Order View</div>
                                    </div>
                                </div>
															...
															@if(isset($ShowAMCPoDetailsData))
																@foreach($ShowAMCPoDetailsData as $AmcPoValue)
																	<tr>
																		...
																		<td align="center">{{$AmcPoValue->tax_type}}</td>
		...
		$('body').on("click","#SubmitApplication", function(event){
			if(KillEvent == 0){
				...
				BootstrapDialog.show({
					...
					message: "Are you sure you want to submit your Purchase Order Details ,,,?<br><span style='color:red'>If you submit your application, you can't edit further.</span>",
