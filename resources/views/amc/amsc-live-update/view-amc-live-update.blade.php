					...
					<div class="container" align="center">
					 	...
					 	<div class="div12 no-margin">
							<div class="rm-toolbar">
								<span class="rm-with-selected-btn" id="rm-withSelectedBtn">AMC Live Update List</span>
								...
								<div class="rm-toolbar-right">
									...
									@php $AddUrl = 'amc.amsc-live-update'; @endphp 
									@php $BackUrl = 'amc.amsc-live-update'; @endphp 
							...
							<div class="rm-table-wrap">
								<table id="rm-empTable">
									<thead>
										...
										<th class="rm-sortable" data-col="name"><div class="rm-th-inner">Discipline <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="width:12px;height:12px"><path d="M7 8l5-5 5 5M7 16l5 5 5-5"/></svg></div></th>
										...
										<th class="rm-sortable" data-col="name"><div class="rm-th-inner">AMC Based On <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="width:12px;height:12px"><path d="M7 8l5-5 5 5M7 16l5 5 5-5"/></svg></div></th>
										...
										<th class="rm-sortable" data-col="name"><div class="rm-th-inner">AMC Cost<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="width:12px;height:12px"><path d="M7 8l5-5 5 5M7 16l5 5 5-5"/></svg></div></th>
										<th class="rm-sortable" data-col="name"><div class="rm-th-inner">Tax On Cost<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="width:12px;height:12px"><path d="M7 8l5-5 5 5M7 16l5 5 5-5"/></svg></div></th>
										<th class="rm-sortable" data-col="name"><div class="rm-th-inner">Location Name<svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="width:12px;height:12px"><path d="M7 8l5-5 5 5M7 16l5 5 5-5"/></svg></div></th>
										...
										@if(isset($data['data']))
											@foreach($data['data'] as $Role)
												<tr data-name="{{ $Role->role_name }}" data-status="{{ $Role->active == 1 ? 'active' : 'inactive' }}">
													...
													<td align="center"><label class="rm-toggle"><input type="checkbox" {{ $Role->active == 1 ? 'checked' : '' }}><span class="rm-slider"></span></label></td>
												</tr>
											@endforeach
										@endif
