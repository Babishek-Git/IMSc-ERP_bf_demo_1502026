...
if(isset($data['HomeTownData']))
{
	...
	$HomeTownData = Count($HomeTownData);
}
@endphp
					 	...
					 	<div class="div12 no-margin">
							<div class="rm-toolbar">
								...
								<div class="rm-toolbar-right">
									...
									@php $AddUrl  = 'change-request.home-town-request'; @endphp 
										...
										@if(isset($data['HomeTownData']))
											@foreach($data['HomeTownData'] as $HomeTownData)
												...
												<tr data-name="{{ $ContactData->emp_no }}" data-status="{{ $ContactData->active == 1 ? 'active' : 'inactive' }}">
													...
													<td align="center"><button type="button" name="btn_edit" class="btn btn-default tuploadbtn" id="btn_edit" value=" Edit" onclick="window.location='{{ route('change-request.empcontact-change-request',['id'=>encrypt($ContactData->change_req_id),'Page'=>encrypt('REQ')]) }}'"> <i class='fa fa-edit'></i> View & Edit</button></td>
													<td align="center">
