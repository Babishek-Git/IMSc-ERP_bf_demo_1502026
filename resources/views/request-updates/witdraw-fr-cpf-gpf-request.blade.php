					...
					<div class="container" align="center">
					 	...
					 	<div class="div12 no-margin">
							<div class="rm-toolbar">
								<span class="rm-with-selected-btn" id="rm-withSelectedBtn">Withdraw from CPF/GPF. Update Request List</span>
								...
								<div class="rm-toolbar-right">
									...
									@php $AddUrl  = 'change-request.witdraw-fr-cpf-gpf-request'; @endphp 
									@php $BackUrl = 'request-updates.witdraw-fr-cpf-gpf-request'; @endphp 
										...
										@if(isset($data['IdData']))
											@foreach($data['IdData'] as $IdData)
												<tr data-name="{{ $IdData->emp_no }}" data-status="{{ $IdData->active == 1 ? 'active' : 'inactive' }}">
													...
													<td>Withdraw from CPF/GPF Update Request</td>
