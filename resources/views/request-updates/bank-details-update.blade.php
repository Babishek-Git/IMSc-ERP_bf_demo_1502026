										...
										@if(isset($data['BankData']))
											...
											@endphp
												<tr data-name="{{ $BankData->emp_no }}" data-status="{{ $BankData->active == 1 ? 'active' : 'inactive' }}">
													...
													<td align="center"><button type="button" name="btn_edit" class="btn btn-default tuploadbtn" id="btn_edit" value=" Edit" onclick="window.location='{{ route('change-request.empbankdetails-change-request',['id'=>encrypt($BankData->change_req_id),'Page'=>encrypt('REQ')]) }}'"> <i class='fa fa-edit'></i> View & Edit </button></td>
													<td align="center">
