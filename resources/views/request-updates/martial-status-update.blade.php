										...
										@if(isset($data['MaritalData']))
											@foreach($data['MaritalData'] as $MaritalData)
												<tr data-name="{{ $MaritalData->emp_no }}" data-status="{{ $MaritalData->active == 1 ? 'active' : 'inactive' }}">
													...
													<td align="center"><button type="button" name="btn_edit" class="btn btn-default tuploadbtn" id="btn_edit" value=" Edit" onclick="window.location='{{ route('change-request.maritalstatus-change-request',['id'=>encrypt($MaritalData->change_req_id),'Page'=>encrypt('REQ')]) }}'"> <i class='fa fa-edit'></i>View &  Edit </button></td>
													<td align="center">
