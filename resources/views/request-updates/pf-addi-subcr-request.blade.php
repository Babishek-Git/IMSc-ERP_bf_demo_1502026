					...
					<div class="container" align="center">
					 	...
					 	<div class="div12 no-margin">
							<div class="rm-toolbar">
								<span class="rm-with-selected-btn" id="rm-withSelectedBtn">PF Additional Subscription. Update Request List</span>
								...
								<div class="rm-toolbar-right">
									...
									@php $AddUrl  = 'change-request.pf-addi-subcr-request'; @endphp 
									@php $BackUrl = 'request-updates.pf-addi-subcr-request'; @endphp 
										...
										@if(isset($data['IdData']))
											@foreach($data['IdData'] as $IdData)
												<tr data-name="{{ $IdData->emp_no }}" data-status="{{ $IdData->active == 1 ? 'active' : 'inactive' }}">
													...
													<td>LTC Adavance Update Request</td>
