			...
			<div class="grid_12">
				...
				<div class="container" align="center">
										...
										<tr>
											...
											@if($bank->active == 1)
												<td align="center" style="width:50px">
													<button type="button" name="btn_edit" id="btn_edit" class="btn btn-default teditbtn estEdit" onclick="edit('{{ route('bank.bankbranch', ['id' => encrypt($bank->branch_id)]) }}')" title="Click here to Edit" style="cursor: pointer;"><i class="fa fa-edit pt2"></i></button>
												</td>
											@else
												<td align="center" style="width:50px">
					...
					<div class="div1 "></div>
						...
						@php $AddUrl = 'bank.BankBranchMaster'; @endphp 
			...
			BootstrapDialog.confirm({
				...
				callback: function(result) {
					if(result){
						$.ajax({ 
							type: 'POST', 
							url: "{{ route('bank.DeleteBankBranch') }}", 
