					...
					<div class="container" align="center">
					 	<div class="div12 no-margin">
							<div class="rm-toolbar">
								<span class="rm-with-selected-btn" id="rm-withSelectedBtn">SD List</span>
								...
								<div class="rm-toolbar-right">
									...
									@php $AddUrl  = 'sdpo-entry.sd-entry'; @endphp 
									@php $BackUrl = 'sdpo-entry.view-sd'; @endphp 
									<button type="button" class="rm-new-emp-btn" onClick="window.location='{{route($AddUrl)}}'">+ NEW SD ENTRY</button>
								</div>
							</div>
