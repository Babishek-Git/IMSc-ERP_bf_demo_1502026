										...
										<div class="form-step active"> 
                                            <fieldset class="fieldbox">
												...
												<div class="fieldbox-div">
                                                    ...
                                                    <div class="div2"><input type="text" name="txt_sd_percentage" id="txt_sd_percentage" class="tboxsmclass" value=""></div> 
                                                    <div class="div2 label pd-l-20">SD Amount</div>
                                                    <div class="div2"><input type="text" name="txt_sd_amount" id="txt_sd_amount" class="tboxsmclass" value=""></div> 
                                                    <div class="div2 label pd-l-20">SD Recieved Date</div>
													<div class="div2"><input type="text" name="txt_sd_date" id="txt_sd_date" class="tboxsmclass  datepicker" value=""></div>
                                                    <div class="row smclearrow"></div>
													<div class="row smclearrow"></div>
