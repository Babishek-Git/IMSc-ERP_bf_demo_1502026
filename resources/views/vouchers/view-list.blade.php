                    ...
                    <div class="container">
                        ...
                        <div class="div12 no-margin">
							<div class="rm-toolbar">
								<span class="rm-with-selected-btn" id="rm-withSelectedBtn">Voucher View List</span>
								...
								<table id="rm-empTable" class="VoucherTable">
									...
									<tbody>
                                        ...
                                        <tr data-name="{{ $Payment->payment_id }}" data-status="{{ $Payment->active == 1 ? 'active' : 'inactive' }}">
                                            ...
                                            <td width="50">{{ $Payment->voucher_no ?? '' }}</td>
                                            <td width="50">{{ isset($Payment->voucher_dt) ? Helper::DisplayDateFormat($Payment->voucher_dt) : '' }}</td>
                                            <td width="50">{{ isset($Payment->voucher_amt) ? Helper::IndianMoneyFormat($Payment->voucher_amt) : '' }}</td>
                                        </tr>
