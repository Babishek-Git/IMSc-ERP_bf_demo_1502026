																...
																@if(isset($data['MaterialInwardDetailData']))
																	...
																	@foreach($data['MaterialInwardDetailData'] as $MatValue)
																		<tr>
                                                                            ...
                                                                            <td align="center">{{ $MatValue->payment_perc ? $MatValue->payment_perc : '' }}</td>
																			<td align="right">{{ $MatValue->total_payment_amout ? $MatValue->total_payment_amout : '' }}</td>
                                                                            <input type="hidden" name="txt_item_pay_perc[]" id="txt_item_pay_perc_{{$Sno}}" data-index ='{{$Sno}}' class="tboxsmclass decimalnum percvalue" style="width:100%; text-align:right"  value="{{ $MatValue->payment_perc ? $MatValue->payment_perc : '' }}" >
