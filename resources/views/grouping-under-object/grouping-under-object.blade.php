						...
						<div class="container">
							<div class="row ">
								...
								<div class="div6 mbtable">
									<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Grouping Under Object Head</div></div></div>
											...
											<div class="div9">                                                
                                                <div class = "GR1">
                                                    <select class="group tboxclass" name="cmb_group[]" id="cmb_group1" data-group = "1">
                                                        ...
                                                        <option value="NEW">ADD New Maincategory</option>
                                                        @if(isset($data['ShowGrandParent']))
                                                            @foreach($data['ShowGrandParent'] as $List)
                                                                <option value="{{ $List->object_head_group_id }}">{{ $List->object_head_group_name }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
