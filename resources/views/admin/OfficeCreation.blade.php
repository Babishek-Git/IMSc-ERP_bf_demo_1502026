								...
								<div class="div8 mbtable">
									...
									<div class="card-body padding-1 ChartCard" id="CourseChart">
										<div class="divrowbox innerdiv pt-2">
											...
											<div class="div9">                                                
                                                <div class = "GR1">
                                                    <select class="group selectlgbox" name="cmb_group[]" id="cmb_group1" data-group = "1" style="width:200px; height:30px" >
											...
											@php $AddUrl = 'admin.viewoffice'; @endphp 										
											<div class="row">
	...
	$(document).ready(function() {
		...
		$('body').on("change",".group", function(e){ 
			...
			if(groupid != ""){
				...
				if(groupid == "NEW"){
					let GrpApp = '<div class="div3 label">Office Name  <span class="reqindi">*</span></div><div class="div9"><input type="text" class="tboxclass OffName"  name="new_group[]" id="new_group'+level+'" maxlength="100" data-group="'+level+'" autocomplete="off" /></div>';
				 		GrpApp += '<div class="div3 label">Office Short Name  <span class="reqindi">*</span></div><div class="div9"><input type="text" class="tboxclass Offshname"  name="txt_office_shortName[]" id="txt_office_shortName'+level+'" maxlength="40" data-group="'+level+'" autocomplete="off" /></div>';
					...
					$.ajax({ 
						...
						success: function (data) { 
							if(data != null){
								...
								$('.GR'+level).last().after('<div class = "GR'+nextLevel+'"><div class="row smclearrow"><div class="div3 label">Group '+nextLevel+'</div><div class="div9"><select class="group selectlgbox2" name="cmb_group[]" id="cmb_group'+nextLevel+'" data-group="'+nextLevel+'" style="width:200px; height:30px" >'+OptionList+'</select></div><div class = "GR'+nextLevel+'"><div class="row smclearrow"></div>');
