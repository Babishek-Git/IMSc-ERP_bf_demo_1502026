                    ...
                    <blockquote class="bq1">
                        <form name="form" method="post" action="">
							...
							<!--<tr> 
									...
									<td  class="labeldisplay">-->
										<select name='cmb_zone_name' id='cmb_zone_name' class="textboxdisplay" style="width:405px; visibility:hidden">
								...
								<tr>
									<td>&nbsp;&nbsp;</td><td width="25%" class="label"></td>
									<td id="val_zone_name" style="color:red"></td>
								</tr>-->
						...
						<div align="center" class="label" style="color:#CC0047">
							* After Completion of Check Measurements, MBook Print Option will be Enabled.
						</div>
