...
@include('layouts.header')
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <form action="" method="post" enctype="multipart/form-data" name="phuploader">
            ...
            <!--==============================Content=================================-->
            <div class="content"> 
                <div class="title">Decimal Assign</div>
                            ...
                            <div class="container" > 
								...
								<table width="90%" class="table1 table2">
									...
									<tr class="table-row">
										...
										<td class="col"></td>
										<td class="col">
										<input type="text" class="textboxdisplay textboxstyle" style="color:#003399; width:65px" name="txt_decimal_placed" id="txt_decimal_placed" value=""  onkeypress="return IsAlphaNumeric(event);" onBlur="get_decimal_val(,this);"  >
