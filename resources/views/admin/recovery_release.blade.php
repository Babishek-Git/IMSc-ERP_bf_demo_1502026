                        ...
                        <blockquote class="bq1">
							...
							<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="color1">
									...
									<tr>
										...
										<td><input type="text" name='txt_rbn' id='txt_rbn' class="textboxdisplay" value="" style="width: 465px;"></td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" name='txt_rec_rel_desc' id='txt_rec_rel_desc' class="textboxdisplay" value="" style="width: 465px;"></td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" name='txt_rec_rel_amt' id='txt_rec_rel_amt' class="textboxdisplay" value="" style="width: 465px;"></td>
									</tr>
