			...
			<div class="grid_12">
				...
				<div class="container" align="center">
									...
									@foreach($data['ShowWorkFlow'] as $WorkFlow)
										<tr>
											...
											<td align="center" style="width:50px">
												<button type="button" name="btn_edit" id="btn_edit" class="btn btn-default teditbtn estEdit" onclick="edit('{{ route('admin.workflow', ['id' => encrypt($WorkFlow->wf_moduleid)]) }}')" title="Click here to Edit" style="cursor: pointer;"><i class="fa fa-edit pt2"></i></button>
											</td>
											<!-- <td align="center" style="width:50px">
					...
					<div class="div1 "></div>
						...
						@php $AddUrl = 'admin.workflow'; @endphp 
