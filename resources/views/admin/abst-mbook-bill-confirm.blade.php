...
<form name="form" method="post" onsubmit="return confirm('Do you really want to confirm the Pass Order and Close the Current RAB ?');">
...
<tr border='1' bgcolor="" class="labelprint">
	...
	<td style="border-top-color:#666666;" width="40px">&nbsp;</td>
		...
		<tr border='1' class="labelprint" style="font-size:11px; color:#F00000">
			<td colspan="12" align="left" bgcolor=""><b>Accounts Remarks &nbsp; :&nbsp;&nbsp;&nbsp;</b></td>
		</tr>
