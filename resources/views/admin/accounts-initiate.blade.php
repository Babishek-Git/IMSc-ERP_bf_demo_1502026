...
<body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
    ...
    @include('admin.menu')
        <!--==============================Content=================================-->
        <div class="content">
             <div class="title">Accounts Initiate</div>
            <div class="container_12">
                <div class="grid_12">
                    <blockquote class="bq1">
                        <form name="form" method="post" action="AccountsGenerateSection1.php">
                            <div class="container">
                             <table width="100%"  bgcolor="#E8E8E8" border="0" cellpadding="0" cellspacing="0" align="center" >
                                ...
                                <tr>
                                 ...
                                 <tr>
								   	...
								   	<td  class="labeldisplay"><input type="text" name="txt_rbn_no" id="txt_rbn_no"  class="textboxdisplay" style="width: 465px;" requied></td>
								   	<td>&nbsp;</td>
								   	<td>&nbsp;</td>
								</tr>
                                <tr>
