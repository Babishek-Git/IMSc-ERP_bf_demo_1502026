...
<tr>
	<td colspan='3' align='right' class='labelbold'>C/o Page No / Abstract MB No / Abstract MB No </td>
	<td></td>
	<td></td>
...
<table width="1087px" border="0"  cellpadding="2" cellspacing="2" align="center" bgcolor="#FFFFFF" style="border:none;" class="labelprint">
	<tr style="border:none;"><td align="center" style="border:none;">Abstract M.Book No. <!--(Print version : )-->&nbsp;&nbsp;</td></tr>
</table>
<table width='1087px' cellpadding='3' cellspacing='3' align='center' class='label table1' bgcolor='#FFFFFF' id='table1'>
...
<input type="hidden" name="hid_item_str" id="hid_item_str<?php //echo $subdivid; ?>" value="" />
