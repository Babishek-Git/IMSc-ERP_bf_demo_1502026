...
<form name="form" method="post" onsubmit="return confirm('Do you really want to submit the Book?');">
	...
	<tr border='1' bgcolor="" class="labelprint">
		<!--<td  align='center' width='' class='labelsmall' style=" border-top-color:#666666; border-bottom-color:#0A9CC5; background-color:#0A9CC5" id="td_popupbutton">
		...
		<tr border='1' bgcolor="#DF00FE" class="labelprint">
				...
				<td  align='left' width='' class='' style="font-size:10px;"></td>
			...
			<tr border='1' class="labelprint" style="font-size:10px;">
				...
				<tr border='1' class="labelprint" bgcolor="#B3E4FF">
					<td  align='right' width='' class='labelbold' colspan="2">Deduct Deviated Qty.</td>
					<td  align='right' width='' class=''>-</td>
					<td  align='right' width='' class=''></td>
					<td  align='left' width='' class=''></td>
					<td  align='right' width='' class=''></td>
		...
		<tr border='1' class="labelprint" bgcolor="">
			...
			<!--<tr style="background-color:#A0EAFA"><td colspan="12"></td></tr>--
	...
	<tr class='labelprint'><td colspan='12' align='center' style='border-bottom:2px solid white;border-left:2px solid white;border-right:2px solid white;'>Page</td></tr>
	</table>
	<p style='page-break-after:always;'></p>
	<table width="1087px" border="0"  cellpadding="2" cellspacing="2" align="center" bgcolor="#FFFFFF" style="border:none;" class="labelprint">
		<tr style="border:none;"><td align="center" style="border:none;">Abstract M.Book No.&nbsp;&nbsp;</td></tr>
...
<input type="hidden" name="txt_abstractstr" id="txt_abstractstr" value="" />
<input type="hidden" name="txt_subdivid_slmstr" id="txt_subdivid_slmstr" value="" />
<input type="hidden" name="txt_rbn_no" id="txt_rbn_no" value="" />
