...
<form name="form" method="get" action="HistoryAbstract.php">
<div class="content">
	<div class="title"></div>
				...
				<div class="container">
					<div class="row ">
						...
						<div class="div8 mbtable">
							<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center"> Abstract History </div></div></div>
