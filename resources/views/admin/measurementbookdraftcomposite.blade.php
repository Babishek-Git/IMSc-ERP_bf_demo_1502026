					...
					<form name="form" method="post" action="">
						...
						<div class="container">
							...
							<div class="div8 mbtable" >
							  	<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Sub-Abstract Draft View</div></div></div>
								  	...
								  	<div class="divrowbox innerdiv pt-2">
										...
										<div class="row">
											...
											<div class="div9" id="val_work" style="color:red">
											</div>
										</div>
