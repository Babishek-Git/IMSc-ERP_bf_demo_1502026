								...
								<div class="div8 mbtable">
									...
									<div class="card-body padding-1 ChartCard" id="CourseChart">
										<div class="divrowbox innerdiv pt-2">
											...
											<div class="div9">
											<select name="bank_name" id="bank_name" class="textboxdisplay" style="width:500px;height:30px">
											...
											<div class="div9"><input type="text" maxlength="11" name="ifsc_code" id="ifsc_code" maxlength="50" class="tboxclass alphanumeric" value="@if(isset($data['BankBranchData'])){{ $data['BankBranchData']->ifsc_code }}@endif" style="width:500px"></div>

											<div class="div3 label">Branch Address <span class="reqindi">*</span></div>											
											<div class="div9"><input type="text" name="branch_Address" id="branch_Address" maxlength="150" class="tboxclass" value="@if(isset($data['BankBranchData'])){{ $data['BankBranchData']->branch_addr1 }}@endif" style="width:500px" ></div>

											<div class="div3 label">State Name <span class="reqindi">*</span></div>											
											<div class="div9">
											<select name="state_name" id="state_name" class="textboxdisplay" style="width:500px;height:30px">
												<option value="">--------------- Select ---------------</option>																
											...
											<div class="div9"><input type="text" name="city_name" id="city_name" maxlength="150" class="tboxclass textonly" value="@if(isset($data['BankBranchData'])){{ $data['BankBranchData']->branch_city }}@endif" style="width:500px" ></div>																																																					
											...
											<div class="row smclearrow"></div> 
											@php $AddUrl = 'admin.ViewBankBranchList'; @endphp
											<div class="row">
