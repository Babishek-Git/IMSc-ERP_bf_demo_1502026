...
@include('layouts.partials.messages')
	...
	<form action="" method="post" name="form">
        <div class="content">
			<div class="title">Extra Item View</div>
                    ...
                    <blockquote class="bq1">
						   <div class="container">
								<div class="row ">
									...
									<div class="div8">
										<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">Extra Item Details</div></div></div>
...
<script>
		...
		$.ajax({
			type:'GET',
			url:"{{ route('ajax.GetSupplementaryWorkOrder') }}",
			data:{'work':work ,'page':'EXTRAITEMGEN'},
			success:function(data){ 
				if(data){ 	//alert(JSON.stringify(data['Sheetdata']));
					TrimWorkDet = data['TrimWorkDet'];
					SuppData = data['SuppData'];
					(TrimWorkDet != "")?
					(
						$("#txt_workorder_no").val(value.TrimWorkDet)
					);
				}
			}
		});
