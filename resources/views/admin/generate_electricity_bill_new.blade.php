										...
										<div style="width:95%; height:auto;" align="center">
											<table width="100%" class="table1" id="table1">
												...
												<tr>
													...
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_imr" id="txt_imr"  style="text-align:center" onBlur="calculateEBamount();"></td>
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_imr_date" id="txt_imr_date"  style="background-color:#D7D2D5; text-align:center" readonly=""></td>
													...
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_rate_unit" id="txt_rate_unit" style="background-color:#D7D2D5; text-align:center" readonly=""></td>
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_rent" id="txt_rent" style="background-color:#D7D2D5; text-align:center" readonly=""></td>
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_unit" id="txt_unit" style="background-color:#D7D2D5; text-align:center" readonly=""></td>
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_factor" id="txt_factor" style="background-color:#D7D2D5; text-align:center" readonly=""></td>
