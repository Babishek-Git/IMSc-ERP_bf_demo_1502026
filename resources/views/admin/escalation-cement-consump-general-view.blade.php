  ...
  <form action="" method="post" enctype="multipart/form-data" name="form">
	...
	<div class="content">   
		<div align="center" class="container_12">
			...
			<input type="hidden" name="txt_cc_esc_id" id="txt_cc_esc_id" value="">
			<input type="hidden" name="txt_cc_esc_rbn" id="txt_cc_esc_rbn" value="">
			<input type="hidden" name="txt_start_page" id="txt_start_page" value="">
			<input type="hidden" name="txt_end_page" id="txt_end_page" value="">
			<input type="hidden" name="txt_ccmbook" id="txt_ccmbook" value="">
			<input type="hidden" name="txt_cc_quarter" id="txt_cc_quarter" value="">
