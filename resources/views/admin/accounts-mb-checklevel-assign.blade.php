...
<body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <!--==============================Content=================================-->
        <div class="content">
            <div class="title">MBook Checking - Level Assign</div>
                                ...
                                <table width="100%"  bgcolor="#E8E8E8" border="0" cellpadding="0" cellspacing="0" align="center" >
									...
									<tr>
									   	...
									   	<td  class="labeldisplay">
											...
											<div class="label labelDiv"><input type="checkbox" name="level_check[]" id="level_check1" value="1">&nbsp;&nbsp;Dealing Assistant</div>
											<div class="label labelDiv"><input type="checkbox" name="level_check[]" id="level_check2" value="2">&nbsp;&nbsp;Accountant</div>
											<div class="label labelDiv"><input type="checkbox" name="level_check[]" id="level_check3" value="3">&nbsp;&nbsp;Assistant Accounts Officer</div>
											<div class="label labelDiv"><input type="checkbox" name="level_check[]" id="level_check4" value="4">&nbsp;&nbsp;Accounts Officer</div>
											<div class="label labelDiv"><input type="checkbox" name="level_check[]" id="level_check5" value="5">&nbsp;&nbsp;Deputy Controller of Accounts</div>
										</td>
									   	<td>&nbsp;</td>
									   	<td>&nbsp;</td>
									</tr>
