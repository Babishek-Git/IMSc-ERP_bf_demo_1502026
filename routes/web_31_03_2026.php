    ...
    Route::group(['middleware' => ['auth','ssoauth']], function() { 
		...
		Route::group(['middleware' => ['checkReferrer']], function() { 
			...
			Route::group(['prefix' => 'change-request'], function() {
    			...
    			Route::match(array('GET','POST'),'/empcontact-change-request', 'ChangeRequestController@EmpContactChangeRequest')->name('change-request.empcontact-change-request');
			...
			Route::group(['prefix' => 'LeaveApplication'], function() {
				Route::match(array('GET','POST'),'/LeaveApplication', 'LeaveApplicationController@LeaveApplication')->name('LeaveApplication.LeaveApplication');
				...
				Route::match(array('GET','POST'),'/LeaveMaster', 'LeaveMasterController@LeaveMaster')->name('LeaveMaster.LeaveMaster');
				Route::match(array('GET','POST'),'/LeaveApplicationPendingList', 'LeaveApplicationController@LeaveApplicationPendingList')->name('LeaveApplication.LeaveApplicationPendingList');
			});
			...
			Route::group(['prefix' => 'Vouchers'], function() { 
				...
				Route::match(array('GET','POST'),'/get-paydata-ledger-group', 'VouchersController@GetLegderGroupPayData')->name('Voucher.get-paydata-ledger-group');
			});
			...
			Route::group(['prefix' => 'Material'], function() {
				...
				Route::match(array('GET','POST'),'/MaterialSubmission', 'MaterialInwardController@MaterialInwardSubmission')->name('material.material-inward-submission');
			});
			Route::group(['prefix' => 'register'], function() {
